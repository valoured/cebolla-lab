-- ────────────────────────────────────────────────────────────────
-- Play of the Day (POD) system.
--
-- Every day, an automated pick. One row per slate. The system:
--   1. Picks the single best HR prop where projected_prob >= 0.30
--      and edge is the largest among qualifying picks
...
CREATE TABLE IF NOT EXISTS pods (
    ...
    market              TEXT NOT NULL,                  -- 'hr_0.5' for now
